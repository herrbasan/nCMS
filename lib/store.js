...
//
// Deliberately NOT a folder move: nDB's Node API has no `close()`, so the database handle stays
// open for the life of the process and Windows refuses to rename an open file (EPERM). Marking
// is also the truer model — the two stages mean different things, and neither is a filesystem
// operation.
